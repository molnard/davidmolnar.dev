...
export const ui = {
  en: {
    ...
    'hero.sub':
      'Senior software engineer with 15+ years shipping distributed systems, embedded hardware, and Bitcoin privacy software. Former CTO at Wasabi Wallet, now working as an independent contractor on Ginger Wallet, Fetaphon, TESCO, AGIS, and more. Hungary.',
    ...
    'about.title': 'About',
    'about.body':
      'I\u2019m David Molnar, a senior software engineer based in . 15+ years shipping distributed systems, embedded hardware, and Bitcoin privacy software. I spent six years at Wasabi Wallet, eventually as CTO, building one of the most widely used Bitcoin privacy wallets \u2014 4,600+ commits across the protocol and client. Today I work as an independent contractor on several parallel projects, including Ginger Wallet, Fetaphon, TESCO, and AGIS. I take on hard problems: protocol-level Bitcoin privacy, battery-powered embedded devices that have to run for years, and industrial parts with real tolerances.',
  ...
  hu: {
    ...
    'hero.sub':
      'Senior szoftverfejlesztő 15+ év tapasztalattal — elosztott rendszerek, embedded hardver és Bitcoin privacy szoftverek. Korábban CTO a Wasabi Walletnél, ma független szoftverfejlesztő egyéni vállalkozóként — Ginger Wallet, Fetaphon, TESCO, AGIS és további projektek. .',
