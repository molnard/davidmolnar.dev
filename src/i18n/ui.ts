...
export const ui = {
  en: {
    ...
    'hero.sub':
      'Senior software engineer with 15+ years building software, 8 of them on Bitcoin privacy. Former CTO at Wasabi Wallet, now an independent contractor on Ginger Wallet, Fetaphon, TESCO, AGIS, and more. Hungary.',
  ...
  hu: {
    ...
    'hero.sub':
      'Senior szoftverfejlesztő 15+ év tapasztalattal, ebből 8 év aktív Bitcoin fejlesztés. Korábban CTO a Wasabi Walletnél, ma független szoftverfejlesztő egyéni vállalkozóként — Ginger Wallet, Fetaphon, TESCO, AGIS és további projektek. .',
